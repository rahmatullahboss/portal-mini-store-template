...
function buildTokenCookie(token: string, cookiePrefix: string | undefined, expiresInSeconds: number): string {
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if ((body as any)._payload) {
      const payloadData = typeof (body as any)._payload === "string" 
