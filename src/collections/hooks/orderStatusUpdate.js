...
const orderStatusUpdate = async ({ doc, previousDoc, operation, req }) => {
    ...
    `;
      ...
      `;
        ...
        req?.payload?.logger?.error?.('Order status update notification failed', error);
    }
    return doc;
};
exports.default = orderStatusUpdate;
